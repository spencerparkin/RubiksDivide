...
bool RubDivSolverV1::FindAlgorithm( RubDivPuzzle::MoveList& algorithm )
{
...
bool RubDivSolverV1::FindAlgorithmForRow( int row, const RubDivPuzzle::Move& rotationMove, RubDivPuzzle::MoveList& algorithm )
{
	int size = puzzleClone->GetSize();
